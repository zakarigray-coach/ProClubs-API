...
async function renderNewspaper({ team = {}, teamKey = 'birmingham', type = 'club', story = {}, date = '', issueNumber = 1, heroBuffer = null, brandBuffer = null, mastheadBuffer = null } = {}) {
  ...
  const hero = await safeImage(heroBuffer, 620, 720, 'cover', 'attention');
  ...
  if (hero) composites.push({ input: hero, left: 380, top: 590 });

  const storyCards = rows.map((row, i) => {
    const x = 34 + i * 241;
    const body = wrap(row[2], 25, i === 3 ? 2 : 3);
    return '<rect x="' + x + '" y="1165" width="225" height="138" fill="#070B10" stroke="' + t.accent + '" stroke-width="2"/>' +
      '<text x="' + (x + 14) + '" y="1192" font-family="DejaVu Sans" font-size="13" font-weight="900" fill="' + t.accent + '">0' + row[0] + '  ' + esc(row[1]) + '</text>' +
      textLines(body, x + 14, 1220, 20, 'font-family="DejaVu Serif" font-size="14" font-weight="500" fill="#F5F5F5"');
  }).join('');
  ...
  const svg = '<svg width="' + WIDTH + '" height="' + HEIGHT + '" xmlns="http://www.w3.org/2000/svg">' +
    '<defs><filter id="grain"><feTurbulence baseFrequency=".7" numOctaves="3" seed="12"/><feColorMatrix values=".8 0 0 0 .2 0 .8 0 0 .2 0 0 .8 0 .2 0 0 0 .09 0"/></filter><linearGradient id="club" x1="0" y1="0" x2="1" y2="0"><stop stop-color="' + t.royal + '"/><stop offset=".72" stop-color="' + t.royal + '"/><stop offset="1" stop-color="' + t.deep + '"/></linearGradient></defs>' +
    '<rect width="1024" height="1536" fill="' + t.paper + '"/><rect x="12" y="12" width="1000" height="1512" fill="none" stroke="#171717" stroke-width="3"/>' +
    '<rect x="24" y="20" width="976" height="185" fill="' + t.deep + '"/><rect x="24" y="20" width="976" height="185" filter="url(#grain)" opacity=".55"/>' +
    ...
    '<text x="812" y="72" font-family="DejaVu Sans" font-size="18" font-weight="900" fill="#fff">REAL CLUBS.</text><text x="812" y="100" font-family="DejaVu Sans" font-size="18" font-weight="900" fill="#fff">REAL STORIES.</text><text x="812" y="128" font-family="DejaVu Sans" font-size="18" font-weight="900" fill="#fff">ALL FOOTBALL</text><text x="812" y="156" font-family="DejaVu Sans" font-size="18" font-weight="900" fill="#fff">THAT MATTERS.</text>' +
    '<rect x="24" y="207" width="976" height="34" fill="#F8F4EA" stroke="#111"/><text x="38" y="230" font-family="DejaVu Sans" font-size="13" font-weight="900" fill="#111">' + esc(dateLabel(date)) + '</text><text x="512" y="230" text-anchor="middle" font-family="DejaVu Sans" font-size="12" font-weight="800" fill="#111">CLUB NEWS  |  MATCHDAY  |  TRANSFERS  |  COMMUNITY</text><text x="982" y="230" text-anchor="end" font-family="DejaVu Sans" font-size="13" font-weight="900" fill="#111">ISSUE #' + esc(String(issueNumber || 1)) + '</text>' +
    '<rect x="24" y="247" width="976" height="145" fill="url(#club)"/><text x="174" y="312" font-family="DejaVu Serif" font-size="' + (club.length > 18 ? 50 : 60) + '" font-weight="900" fill="#fff">' + esc(club) + '</text><text x="178" y="354" font-family="DejaVu Serif" font-size="23" font-weight="700" letter-spacing="7" fill="#fff">FOOTBALL CLUB</text>' + textLines(league, 790, 285, 25, 'font-family="DejaVu Sans" font-size="16" font-weight="900" fill="#fff"') +
    '<rect x="24" y="405" width="976" height="35" fill="' + t.royal + '"/><text x="48" y="429" font-family="DejaVu Sans" font-size="16" font-weight="900" letter-spacing="6" fill="#fff">EXCLUSIVE</text>' +
    textLines(headline.lines, 34, 505, headline.dy, 'font-family="DejaVu Serif" font-size="' + headline.size + '" font-weight="900" fill="#080808"') +
    textLines(sub, 36, 650, 30, 'font-family="DejaVu Sans" font-size="25" font-weight="900" fill="' + t.royal + '"') +
    '<line x1="36" y1="686" x2="988" y2="686" stroke="#111" stroke-width="2"/>' +
    '<rect x="34" y="710" width="330" height="430" fill="#F4EFE5"/>' + textLines(article, 44, 750, 27, 'font-family="DejaVu Serif" font-size="18" font-weight="500" fill="#171717"') +
    '<line x1="44" y1="1000" x2="105" y2="1000" stroke="' + t.royal + '" stroke-width="4"/><text x="44" y="1032" font-family="DejaVu Sans" font-size="15" font-weight="900" fill="#111">BY ' + esc(reporter) + '</text><text x="44" y="1055" font-family="DejaVu Sans" font-size="12" font-weight="800" fill="#333">RT FOOTBALL MEDIA</text>' +
    (hero ? '' : '<rect x="380" y="590" width="620" height="720" fill="#142A42"/><text x="690" y="930" text-anchor="middle" font-family="DejaVu Sans" font-size="25" font-weight="900" fill="#fff">RT FOOTBALL MEDIA</text>') +
    storyCards +
    '<rect x="24" y="1320" width="976" height="184" fill="#03080D"/><line x1="24" y1="1320" x2="1000" y2="1320" stroke="' + t.accent + '" stroke-width="5"/><text x="220" y="1392" font-family="DejaVu Serif" font-size="46" font-weight="900" fill="#fff">' + esc(footerMain) + '</text><text x="220" y="1450" font-family="DejaVu Sans" font-size="50" font-weight="900" font-style="italic" fill="' + t.accent + '">' + esc(footerAccent) + '</text><text x="220" y="1482" font-family="DejaVu Sans" font-size="13" font-weight="800" letter-spacing="2" fill="#fff">' + esc(club) + '  |  ' + esc(teamKey === 'crownfc' ? 'MLPC' : 'MASTERS PREMIER LEAGUE') + '  |  2026/27</text></svg>';
