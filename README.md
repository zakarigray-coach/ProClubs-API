...
The bot publishes match reports, player signings, weekly recaps, Player Spotlights, awards, and departures as dated RT Football Media front pages. Signing and Spotlight editions use the approved 1024×1536 printed-tabloid system: distressed paper, floodlit RT MEDIA masthead and crown, weekday/date bar, club-and-league strip, oversized complete headline, narrow news brief, large hero photograph, distinct `INSIDE TODAY` teasers, and a dark lower editorial panel. Every visible entry is a complete sentence; the renderer never adds ellipses, never cuts a paragraph mid-sentence, and does not repeat the lead summary in the sidebar. Each story receives fresh AI-generated hero artwork, while exact typography and the Eastern-Time publication date are rendered separately. Public posts contain the finished front page without repeating the full article as a long Discord embed.
